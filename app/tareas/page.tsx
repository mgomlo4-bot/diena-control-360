...
export default function TareasPage() {
  ...
  useEffect(() => {
    async function loadTasks() {
      try {
        setManualTasks(await getManualTasks());
        setLoadError(null);
      } catch (error) {
  ...
  return (
    <section className="space-y-6">
      <div className="rounded-3xl border border-slate-800 bg-slate-900 p-8 shadow-xl">
        ...
        <p className="mt-3 max-w-4xl text-slate-300">Bandeja unificada de tareas automáticas derivadas de hitos y tareas manuales gestionadas mediante dataRepository.</p>
